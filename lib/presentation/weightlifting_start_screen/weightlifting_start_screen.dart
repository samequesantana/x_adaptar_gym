...
import 'provider/weightlifting_start_provider.dart';

class WeightliftingStartScreen extends StatefulWidget {
  const WeightliftingStartScreen({Key? key}) : super(key: key);

  @override
  WeightliftingStartScreenState createState() =>
      WeightliftingStartScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => WeightliftingStartProvider(),
        child: WeightliftingStartScreen());
  }
}

class WeightliftingStartScreenState extends State<WeightliftingStartScreen> {
  @override
  void initState() {
    super.initState();
  }
  ...
  /// Navigates to the warmingUpStoppedOderScreen when the action is triggered.
