...
import 'provider/warming_up_next_provider.dart';

class WarmingUpNextScreen extends StatefulWidget {
  const WarmingUpNextScreen({Key? key}) : super(key: key);

  @override
  WarmingUpNextScreenState createState() => WarmingUpNextScreenState();

  static Widget builder(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => WarmingUpNextProvider(),
        child: WarmingUpNextScreen());
  }
}

class WarmingUpNextScreenState extends State<WarmingUpNextScreen> {
  @override
  void initState() {
    super.initState();
  }
    ...
    return Align(
        ...
        child: Container(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              SizedBox(height: 2.v),
              Text("lbl_01_20".tr, style: theme.textTheme.displayLarge),
